...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/Helmet/helmet.yaml', help='data.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='Helmet/logs', help='logging directory')
    ...
    if opt.resume:  # resume an interrupted run
        ...
        with open(log_dir / 'opt.yaml',encoding='utf-8') as f:
